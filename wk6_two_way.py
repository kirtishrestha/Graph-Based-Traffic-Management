...
# Adding roads (edges) with traffic-weighted distances (weights, bidirectional)
roads = [
    ("A", "B", 4), ("A", "C", 2),
    ("B", "C", 1), ("B", "D", 5), ("B", "E", 7),
    ("C", "D", 8), ("C", "F", 10),
...
# Adding roads as bidirectional connections
for u, v, w in roads:
    G.add_edge(u, v, weight=w)
    G.add_edge(v, u, weight=w)  # Make bidirectional
